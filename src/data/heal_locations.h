static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TOBAACHI_TOWN - 1] = {MAP_GROUP(TOBAACHI_TOWN), MAP_NUM(TOBAACHI_TOWN), 23, 36},
    [HEAL_LOCATION_AURIGA_TOWN - 1] = {MAP_GROUP(AURIGA_TOWN), MAP_NUM(AURIGA_TOWN), 21, 12},
    [HEAL_LOCATION_HOZUNI_CITY - 1] = {MAP_GROUP(HOZUNI_CITY), MAP_NUM(HOZUNI_CITY), 18, 8},
    [HEAL_LOCATION_NOAGA_TOWN - 1] = {MAP_GROUP(NOAGA_TOWN), MAP_NUM(NOAGA_TOWN), 19, 17},
    [HEAL_LOCATION_MISSION_YNEZ - 1] = {MAP_GROUP(MISSION_YNEZ), MAP_NUM(MISSION_YNEZ), 18, 14},
    [HEAL_LOCATION_KUTSNO_TOWN - 1] = {MAP_GROUP(KUTSNO_TOWN), MAP_NUM(KUTSNO_TOWN), 16, 16},
};
