...
u16 ChooseRandomEggSpecies(void) {
    static const u16 baby_species[] = { SPECIES_WYNAUT, SPECIES_SMOOCHUM, SPECIES_ELEKID, SPECIES_MAGBY, SPECIES_HAPPINY, SPECIES_CLEFFA, SPECIES_IGGLYBUFF, SPECIES_MUNCHLAX, SPECIES_TOGEPI, SPECIES_MANTYKE };
    u16 randomSpeciesid = Random() % ARRAY_COUNT(baby_species);
    return baby_species[randomSpeciesid];
}